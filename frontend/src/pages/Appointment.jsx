    ...
    return docInfo ? (
        <div>
            ...
            <div className='sm:ml-72 sm:pl-4 mt-8 font-medium text-[#565656]'>
                ...
                {/* Show selection hint */}
                {!slotTime && (
                    <p className='text-xs text-gray-400 mt-2'>Please select a time slot above before booking</p>
                )}

                <button
                    onClick={bookAppointment}
                    disabled={loading}
                    className='bg-primary text-white text-sm font-light px-20 py-3 rounded-full my-6 disabled:opacity-60 disabled:cursor-not-allowed'
                >
